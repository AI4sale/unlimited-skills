...
RELEASE_DOCS = [
    ...
    ROOT / "docs" / "releases" / "v0.4.4-alpha-upgrade-notes.md",
...
def assert_manifest() -> dict[str, Any]:
    ...
    require(git.get("publication_branch") == "release/v0.4.4-alpha-final-publication", "publication branch mismatch")
    ...
    for key in ("alpha_only", "fixture_mode", "mcp_tool_profile_integration", "profile_runtime_enforcement", "codex_pushes_tag"):
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Verify v0.4.4-alpha publication before Codex tagging.")
    ...
    report = {
        ...
        "profile_runtime_enforcement": True,
    ...
    if args.json:
        ...
        print("profile runtime enforcement: yes")
