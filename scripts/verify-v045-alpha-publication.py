...
RELEASE_DOCS = [
    ...
    ROOT / "docs" / "releases" / "v0.4.5-alpha-upgrade-notes.md",
...
def assert_manifest() -> dict[str, Any]:
    ...
    require(git.get("publication_branch") == "release/v0.4.5-alpha-final-publication", "publication branch mismatch")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Verify v0.4.5-alpha publication before Codex tagging.")
    ...
    report = {
        ...
        "read_only_audit_inspection": True,
        "audit_log_writes": False,
        "audit_writer_changes": False,
    ...
    if args.json:
        ...
        print("no audit writer changes: passed")
