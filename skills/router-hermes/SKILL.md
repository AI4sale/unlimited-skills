...
```bash
"{{HERMES_SH_LAUNCHER}}" suggest "<query>" --limit 3
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "{{HERMES_PS_LAUNCHER}}" suggest "<query>" --limit 3
...
"{{HERMES_SH_LAUNCHER}}" suggest "React component rerender performance" --limit 3
