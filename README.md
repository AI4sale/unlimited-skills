...
- v0.4.9-alpha MCP profile rollout simulator integration is the active release gate for the MCP profile distribution milestone;
...
For the v0.4.9-alpha MCP profile rollout simulator integration milestone,
