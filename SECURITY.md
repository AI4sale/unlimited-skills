...
- Release artifacts are checked by the v0.2.2, v0.3.0, v0.3.2, v0.3.3, and v0.3.4 alpha release verifiers for version consistency, unsafe release claims, final publication placeholders, and obvious private key/token material.
